...
namespace csv
{
	...
	// template<  >
template <typename data_type, typename feature_declaration, typename value_declaration, typename example_declaration>
void read(
    const std::string& fn, 
		feature_declaration add_feature, 
		value_declaration add_value, 
		example_declaration add_example, 

...
Ever since the seminal work from Quinlan on using entropy as a heuristic to compute decision classifiers~\cite{10.1023/A:1022643204877,c4-5}, the question of computing \emph{optimal} decision trees has been alive, and recently a number of algorithms have been introduced for that purpose.
Several variants and criteria have been proposed. %, e.g. computing the perfect classifier of minimum size~\cite{}, 
Among those, computing a depth-bounded decision tree of maximum accuracy is often the preferred criterion~\cite{dl8,verhaeghe2019learning,bertsimas2017optimal,hu2019optimal}, because while being straightforward, it captures many desired features: it is resilient to noisy data, and shallow trees are both easier to explain and less prone to overfitting.
...
Our experimental results show that it outperforms the state of the art, to the exception of \murtree~\cite{DBLP:journals/corr/abs-2007-12652} on relatively shallow trees (typically for maximum depth 4 or 5), for which this its more sophisticated (albeit complex) algorithmic features pay off.
